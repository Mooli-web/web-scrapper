...
class TestTaxonomy:
    CASES = [
        ...
        # دسته‌ی قطعات کامپیوتر و متفرقه
        ("", "منبع تغذیه کامپیوتر 2200 وات ایسوس مدل Pro WS 2200W", "pc-parts"),
        ("", "کیس خالی کامپیوتر گرین مدل G6", "pc-parts"),
        ("", "خنک کننده پردازنده دیپ کول مدل AK620", "pc-parts"),
        ("", "کارت شبکه ایسوس مدل XG-C100C", "pc-parts"),
        ("", "روتر ایسوس مدل ROG Rapture GT-BE19000", "other"),
        # این‌ها نباید به pc-parts بروند:
        ...
        ("", "سیستم گیمینگ با پاور ماژولار 1000 وات و RTX4070", "desktop-pc"),
        # لوازم جانبی: کلمه‌ی آغازین عنوان خودش کالا را می‌سازد؛ «مناسب برای تبلت»
        # فقط سازگاری است. دسته‌ی خام منبع (tablet) نباید ببرد.
        ("tablet", "کیف کلاسوری نیلکین مدل Camshield Bumper مناسب برای تبلت شیائومی Pad 5", "accessories"),
        ("", "کاور سامسونگ مدل S Protective مناسب برای تبلت سامسونگ Galaxy Tab S8/S7", "accessories"),
        ("", "محافظ صفحه نمایش شیشه ای آراری مدل Core مناسب برای تبلت سامسونگ", "accessories"),
        ("", "قلم لمسی سامسونگ مدل S Pen Fold Edition EJ-PF946 مناسب برای گوشی سامسونگ", "accessories"),
        ("", "شارژر دیواری سامسونگ مدل EP-T2510 25 وات", "accessories"),
        # استثناها: کیف پول سخت‌افزاری یک دستگاه است، نه کیفِ دستگاه؛ قاب هارد هم داک است
        ("", "کیف پول سخت افزاری سیف پال مدل X1", "other"),
        ("", "قاب هارد اس اس دی ایسوس مدل TUF Gaming A1", "other"),
    ]
