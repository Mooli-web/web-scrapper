# 🧹 بازبینی داده — بسته 1/2
تو یک ایجنت بازبینی کیفیت دیتای بازار هستی. فایل JSON زیر شامل 800 آگهی از بازارهای ایرانی است.
...
```
همه‌ی 800 ردیف را جواب بده — هیچ id را جا نینداز.
