...
#
# ⚠️ این الگو روی متن آزاد اجرا می‌شود و نفی را نمی‌فهمد: اگر در دلیلِ یک کالای
# بی‌مدل بنویسید «این بنر فروشنده نیست»، خودِ واژه‌ی «بنر» آن را به
# AMBIGUOUS_DEALER_BANNER می‌برد. در دلیلِ ردیف‌های AMBIGUOUS_NO_MODEL هیچ‌کدام
# از واژه‌های زیر را به‌کار نبرید، حتی در جمله‌ی منفی.
